...
void femInit(LoraRadio* r)
{
    ...
    /* Whether the front end amplifies on RECEIVE is femType's to say: the
     * KCT8103L's RX path runs through its own LNA, the GC1109's bypasses the
     * part, and a declared one is switched by the radio's DIOs with nothing
     * here able to tell which it does. loraPublishRowGates reads it back for
     * the caption that mentions it.
     *
