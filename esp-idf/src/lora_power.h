...
/* The per-radio antenna-dBm ceiling is r->maxTxDbm (22 bare chip, the board's
 * declared figure through a FEM — 27 Heltec V4, 35 Station G2; set by
 * femInit); asking a peer for it is what sending nothing already means. */
